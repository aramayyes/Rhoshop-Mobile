...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "myOrdersScreenTitle" : MessageLookupByLibrary.simpleMessage("Мои заказы"),
    ...
    "noOrderText" : MessageLookupByLibrary.simpleMessage("У вас пока нет заказов"),
    "notificationsScreenTitle" : MessageLookupByLibrary.simpleMessage("Уведомления"),
    "orderButtonText" : MessageLookupByLibrary.simpleMessage("Оформить заказ"),
    ...
    "settingsNavigationItem" : MessageLookupByLibrary.simpleMessage("Настройки"),
    "settingsScreenTitle" : MessageLookupByLibrary.simpleMessage("Настройки"),
    "shopNowButtonText" : MessageLookupByLibrary.simpleMessage("Заказать сейчас"),
